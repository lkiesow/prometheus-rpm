...
%changelog
* Tue Sep 08 2026 Lars Kiesow <lkiesow@uos.de> - 3.13.3-4
- Update to 3.13.3

* Wed Aug 19 2026 Lars Kiesow <lkiesow@uos.de> - 3.14.0-4
- Update to 3.14.0

* Fri Jul 31 2026 Lars Kiesow <lkiesow@uos.de> - 3.13.2-4
- Update to 3.13.2

* Sat Jul 11 2026 Lars Kiesow <lkiesow@uos.de> - 3.13.1-4
- Update to 3.13.1

* Fri Jul 10 2026 Lars Kiesow <lkiesow@uos.de> - 3.5.5-4
- Update to 3.5.5

* Thu Jul 02 2026 Lars Kiesow <lkiesow@uos.de> - 3.13.0-4
- Update to 3.13.0

* Thu Jun 18 2026 Lars Kiesow <lkiesow@uos.de> - 3.5.4-4
- Update to 3.5.4

* Fri May 29 2026 Lars Kiesow <lkiesow@uos.de> - 3.12.0-4
- Update to 3.12.0

* Tue Apr 28 2026 Lars Kiesow <lkiesow@uos.de> - 3.11.3-4
- Update to 3.11.3

* Tue Apr 14 2026 Lars Kiesow <lkiesow@uos.de> - 3.11.2-4
- Update to 3.11.2

* Wed Apr 08 2026 Lars Kiesow <lkiesow@uos.de> - 3.11.1-4
- Update to 3.11.1

* Fri Apr 03 2026 Lars Kiesow <lkiesow@uos.de> - 3.11.0-4
- Update to 3.11.0

* Fri Feb 27 2026 Lars Kiesow <lkiesow@uos.de> - 3.10.0-4
- Update to 3.10.0

* Fri Jan 23 2026 Lars Kiesow <lkiesow@uos.de> - 3.5.1-4
- Update to 3.5.1

* Thu Jan 08 2026 Lars Kiesow <lkiesow@uos.de> - 3.9.1-4
- Update to 3.9.1

* Wed Dec 17 2025 Lars Kiesow <lkiesow@uos.de> - 3.8.1-4
- Update to 3.8.1

* Wed Dec 03 2025 Lars Kiesow <lkiesow@uos.de> - 3.8.0-4
- Update to 3.8.0

* Fri Oct 31 2025 Lars Kiesow <lkiesow@uos.de> - 3.7.3-4
- Update to 3.7.3

* Thu Oct 23 2025 Lars Kiesow <lkiesow@uos.de> - 3.7.2-4
- Update to 3.7.2

* Sat Oct 18 2025 Lars Kiesow <lkiesow@uos.de> - 3.7.1-4
- Update to 3.7.1

* Thu Oct 16 2025 Lars Kiesow <lkiesow@uos.de> - 3.7.0-4
- Update to 3.7.0

* Tue Sep 23 2025 Lars Kiesow <lkiesow@uos.de> - 3.6.0-4
- Update to 3.6.0

* Tue Jul 15 2025 Lars Kiesow <lkiesow@uos.de> - 3.5.0-4
- Update to 3.5.0

* Tue Jul 01 2025 Lars Kiesow <lkiesow@uos.de> - 2.53.5-4
- Update to 2.53.5

* Fri Jun 27 2025 Lars Kiesow <lkiesow@uos.de> - 3.4.2-4
- Update to 3.4.2

* Sun Jun 01 2025 Lars Kiesow <lkiesow@uos.de> - 3.4.1-4
- Update to 3.4.1
